...
function initSprites(img) {
	...
	s_text = {
		Flappyfish: new Sprite(img, 59, 114, 96, 22),
	...
	s_music = {
		Off:    new Sprite(img, 15,200,25,30),
		On:   new Sprite(img, 0,200,15,30)
	}
	...
	s_logo = new Sprite(img, 59, 115, 90, 22);
	
	s_medal = [
		new Sprite(img, 173, 114, 25, 23),
		new Sprite(img, 198, 114, 25, 23),
		new Sprite(img, 173, 138, 25, 23),
		new Sprite(img, 198, 138, 25, 23)
	];
